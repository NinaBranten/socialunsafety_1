...
summarytools::freq(NEA2022$gender)
summarytools::freq(NEA2022$gender_v)
```
```{r}
NEA2022 <- dummy_cols(NEA2022, select_columns = "migration", remove_first_dummy = FALSE)
summarytools::freq(NEA2022$migration)
summarytools::freq(NEA2022$migration_eu)
summarytools::freq(NEA2022$migration_noeu)
```
```{r}
NEA2022 <- dummy_cols(NEA2022, select_columns = "education", remove_first_dummy = FALSE)
summarytools::freq(NEA2022$education)
summarytools::freq(NEA2022$education_laag)
summarytools::freq(NEA2022$education_middel)
```
```{r}
NEA2022 <- dummy_cols(NEA2022, select_columns = "leeftijd_", remove_first_dummy = FALSE)
summarytools::freq(NEA2022$leeftijd_)
summarytools::freq(NEA2022$leeftijd__15.35)
summarytools::freq(NEA2022$leeftijd__35.55)
```
