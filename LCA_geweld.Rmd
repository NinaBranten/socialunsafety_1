...
```{r, cache=TRUE}
attach(NEA2022_clust1)
datasg <- data.frame(pesten_col, pesten_leid, intimidation_col, intimidation_leid, seks_col, seks_leid, conflict_col, conflict_leid, conflict_werk, steunleid_R, steuncol_R, psyveil_RR)

itemssg <- cbind(pesten_col, pesten_leid, intimidation_col, intimidation_leid, seks_col, seks_leid, conflict_col, conflict_leid, conflict_werk, steunleid_R, steuncol_R, psyveil_RR) ~ 1
```
<br><br> Variabelen:
...
```{r, cache=TRUE}
model11sg <- poLCA(itemssg, datasg, nclass = 11, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model12sg <- poLCA(itemssg, datasg, nclass = 12, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model13sg <- poLCA(itemssg, datasg, nclass = 13, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model14sg <- poLCA(itemssg, datasg, nclass = 14, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model15sg <- poLCA(itemssg, datasg, nclass = 15, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model16sg <- poLCA(itemssg, datasg, nclass = 16, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model17sg <- poLCA(itemssg, datasg, nclass = 17, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model18sg <- poLCA(itemssg, datasg, nclass = 18, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```
