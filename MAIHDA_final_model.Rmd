...
NEA2022 <- readRDS("data/processed/LCAlist.rds")
...
L_6_a <- lmer(model7_6 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
ggplot(summary_preds_6, aes(x = leeftijd, y = mean_pred_6, color = gender)) +
  ...
  labs(
    title = "Predicted probability overall unsafety Model0",
    y = NULL,
    x = NULL,
    color = "Gender"
  ) +
...
L_4_a <- lmer(model7_4 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
L_7_a <- lmer(model7_7 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
L_5_a <- lmer(model7_5 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
L_1_a <- lmer(model7_1 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
L_2_a <- lmer(model7_2 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
L_3_a <- lmer(model7_3 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
