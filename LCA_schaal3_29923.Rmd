...
```{r, cache=TRUE}
model15s3_29923 <- poLCA(itemss3_29923, datas3_29923, nclass = 15, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model16s3_29923 <- poLCA(itemss3_29923, datas3_29923, nclass = 16, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model17s3_29923 <- poLCA(itemss3_29923, datas3_29923, nclass = 17, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model18s3_29923 <- poLCA(itemss3_29923, datas3_29923, nclass = 18, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```
