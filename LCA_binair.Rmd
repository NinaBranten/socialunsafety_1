...
```{r}
NEA2022$pmodel7_bv1 <- pmodel7_bv1
NEA2022$pmodel7_bv2 <- pmodel7_bv2
NEA2022$pmodel7_bv3 <- pmodel7_bv3
NEA2022$pmodel7_bv4 <- pmodel7_bv4
NEA2022$pmodel7_bv5 <- pmodel7_bv5
NEA2022$pmodel7_bv6 <- pmodel7_bv6
NEA2022$pmodel7_bv7 <- pmodel7_bv7
```
...
cat(
  ...
  "Model 2: ", round(poLCA.entropy(model2_b), 4), "\n",
  "Model 3: ", round(poLCA.entropy(model3_b), 4), "\n",
  "Model 4: ", round(poLCA.entropy(model4_b), 4), "\n",
  "Model 5: ", round(poLCA.entropy(model5_b), 4), "\n",
  "Model 6: ", round(poLCA.entropy(model6_b), 4), "\n",
  "Model 7: ", round(poLCA.entropy(model7_b), 4), "\n",
  "Model 8: ", round(poLCA.entropy(model8_b), 4), "\n",
  "Model 9: ", round(poLCA.entropy(model9_b), 4), "\n",
  "Model 10: ", round(poLCA.entropy(model10_b), 4), "\n",
  "Model 11: ", round(poLCA.entropy(model11_b), 4), "\n",
  "Model 12: ", round(poLCA.entropy(model12_b), 4), "\n"
)
```
...
```{r}
saveRDS(NEA2022, "data/processed/lcabinary.rds")
```
