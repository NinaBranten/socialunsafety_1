...
```{r loading data, echo=TRUE, include=TRUE, results='hide', warning=FALSE, message=FALSE}
...
plot_data7 <- NEA2022 %>%
  ...
  mutate(
    ...
    class_label = recode(as.character(model7_bpred),
                         ...
                         "5" = "Overall safe (56.00%)",
                         "6" = "Overall highly safe (20.36%)",
