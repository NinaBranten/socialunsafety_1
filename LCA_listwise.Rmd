...
cat(
  ...
  "Model 2: ", round(poLCA.entropy(model2_m), 4), "\n",
  "Model 3: ", round(poLCA.entropy(model3_m), 4), "\n",
  "Model 4: ", round(poLCA.entropy(model4_m), 4), "\n",
  "Model 5: ", round(poLCA.entropy(model5_m), 4), "\n",
  "Model 6: ", round(poLCA.entropy(model6_m), 4), "\n",
  "Model 7: ", round(poLCA.entropy(model7_m), 4), "\n",
  "Model 8: ", round(poLCA.entropy(model8_m), 4), "\n",
  "Model 9: ", round(poLCA.entropy(model9_m), 4), "\n",
  "Model 10: ", round(poLCA.entropy(model10_m), 4), "\n",
  "Model 11: ", round(poLCA.entropy(model11_m), 4), "\n",
  "Model 12: ", round(poLCA.entropy(model12_m), 4), "\n"
)
...
```{r}
saveRDS(NEA2022, "data/processed/lcalist.rds")
```