...
```{r}
NEA2022$pmodel7_empv7 <- pmodel7_empv7

NEA2022$pmodel7_empv7_T <- (NEA2022$pmodel7_empv7 * (29923 - 1) + 0.5) / 29923

summary(NEA2022$pmodel7_empv7_T)
summary(NEA2022$pmodel7_empv7)
...
```{r}
NEA2022$predicted_7 <- predict(flb_7_1, type = "response", re.form = NA)
```
...
```{r}
NEA2022$pmodel7_empv1 <- pmodel7_empv1

NEA2022$pmodel7_empv1_T <- (NEA2022$pmodel7_empv1 * (29923 - 1) + 0.5) / 29923

summary(NEA2022$pmodel7_empv1_T)
summary(NEA2022$pmodel7_empv1)
...
```{r}
NEA2022$predicted_1 <- predict(flb_1_1, type = "response", re.form = NA)
```
...
```{r}
NEA2022$pmodel7_empv2 <- pmodel7_empv2

NEA2022$pmodel7_empv2_T <- (NEA2022$pmodel7_empv2 * (29923 - 1) + 0.5) / 29923

summary(NEA2022$pmodel7_empv2_T)
summary(NEA2022$pmodel7_empv2)
...
```{r}
NEA2022$predicted_2 <- predict(flb_2_1, type = "response", re.form = NA)
```
...
```{r}
NEA2022$pmodel7_empv3 <- pmodel7_empv3

NEA2022$pmodel7_empv3_T <- (NEA2022$pmodel7_empv3 * (29923 - 1) + 0.5) / 29923

summary(NEA2022$pmodel7_empv3_T)
summary(NEA2022$pmodel7_empv3)
...
```{r}
NEA2022$predicted_3 <- predict(flb_3_1, type = "response", re.form = NA)
```
...
```{r}
NEA2022$pmodel7_empv4 <- pmodel7_empv4

NEA2022$pmodel7_empv4_T <- (NEA2022$pmodel7_empv4 * (29923 - 1) + 0.5) / 29923

summary(NEA2022$pmodel7_empv4_T)
summary(NEA2022$pmodel7_empv4)
...
```{r}
NEA2022$predicted_4 <- predict(flb_4_1, type = "response", re.form = NA)
```
...
```{r}
NEA2022$pmodel7_empv6 <- pmodel7_empv6
...
```{r}
NEA2022$predicted_6 <- predict(flb_6_1, type = "response", re.form = NA)
```
...
```{r estimated intersectional effects }
#Estimated intersectional effects overall unsafety

re <- ranef(flb_6_1, condVar = TRUE)$cond$intersections
...
#Estimated intersectional effects supervisor unsafety

re <- ranef(flb_4_1, condVar = TRUE)$cond$intersections
...
re <- ranef(flb_7_1, condVar = TRUE)$cond$intersections
...
re <- ranef(flb_5_1, condVar = TRUE)$cond$intersections
...
```{r multinomial multilevel model1, cache=TRUE}
brm_emp7_1 <- brm(
  formula = pred_7_f ~ gender_v + migration_eu + migration_noeu + 
    education_laag + education_middel + leeftijd_35.55 + leeftijd_55.75 +
    (1 | intersections),
