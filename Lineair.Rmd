...
#Predicted probability belonging to overall safe class
...
#Estimated intersectional effects overall safe
...
re_df %>%
  gt() %>%
  tab_header(
    title = "Estimated intersectional effect overall safe"
  ) %>%
  fmt_number(
    columns = c(estimate, se, lower, upper),
    decimals = 3
...
```{r top/bottom 10 overall safe model0, cache=TRUE, results='hide'}
#Top/bottom 10 based on model0
...
<br><br> **Overall highly safe (class 3)**
...
#Predicted probability belonging to overall highly safe class
...
#Estimated intersectional effect overall highly safe
...
re_df %>%
  gt() %>%
  tab_header(
    title = "Estimated intersectional effect overall highly safe"
  ) %>%
  fmt_number(
    columns = c(estimate, se, lower, upper),
    decimals = 3
...
```{r top/bottom 10 overall highly safe model0, cache=TRUE}
#Top/bottom 10 based on model0
