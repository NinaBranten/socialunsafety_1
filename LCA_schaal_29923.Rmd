...
datas29923 <- data.frame(pesten_col, pesten_leid, intimidation_col, intimidation_leid, geweld_col, geweld_leid, seks_col, seks_leid, conflict_col, conflict_leid, conflict_werk, steunleid_R, steuncol_R, psyveil_R)

itemss29923 <- cbind(pesten_col, pesten_leid, intimidation_col, intimidation_leid, geweld_col, geweld_leid, seks_col, seks_leid, conflict_col, conflict_leid, conflict_werk, steunleid_R, steuncol_R, psyveil_R) ~ 1
```
<br><br> Variabelen:
...
```{r, cache=TRUE}
model1s29923 <- poLCA(itemss29923, datas29923, nclass = 1, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model2s29923 <- poLCA(itemss29923, datas29923, nclass = 2, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model3s29923 <- poLCA(itemss29923, datas29923, nclass = 3, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model4s29923 <- poLCA(itemss29923, datas29923, nclass = 4, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model5s29923 <- poLCA(itemss29923, datas29923, nclass = 5, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model6s29923 <- poLCA(itemss29923, datas29923, nclass = 6, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model7s29923 <- poLCA(itemss29923, datas29923, nclass = 7, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model8s29923 <- poLCA(itemss29923, datas29923, nclass = 8, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model9s29923 <- poLCA(itemss29923, datas29923, nclass = 9, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model10s29923 <- poLCA(itemss29923, datas29923, nclass = 10, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model11s29923 <- poLCA(itemss29923, datas29923, nclass = 11, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model12s29923 <- poLCA(itemss29923, datas29923, nclass = 12, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model13s29923 <- poLCA(itemss29923, datas29923, nclass = 13, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model14s29923 <- poLCA(itemss29923, datas29923, nclass = 14, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model15s29923 <- poLCA(itemss29923, datas29923, nclass = 15, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model16s29923 <- poLCA(itemss29923, datas29923, nclass = 16, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model17s29923 <- poLCA(itemss29923, datas29923, nclass = 17, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```

```{r, cache=TRUE}
model18s29923 <- poLCA(itemss29923, datas29923, nclass = 18, maxiter = 5000, nrep = 10, graphs=FALSE, na.rm = FALSE)
```
