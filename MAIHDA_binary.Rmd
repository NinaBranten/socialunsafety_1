...
NEA2022 <- readRDS("data/processed/LCAbinary.rds")
...
Lb_7_g <- lmer(modelb7_7 ~ gender_v + (1 | intersections), data=NEA2022)

Lb_7_m <- lmer(modelb7_7 ~ migration_eu + migration_noeu  + (1 | intersections), data=NEA2022)

Lb_7_e <- lmer(modelb7_7 ~ education_laag + education_middel  + (1 | intersections), data=NEA2022)

Lb_7_a <- lmer(modelb7_7 ~ leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)
...
tab_model(Lb_7_0, Lb_7_g, Lb_7_m, Lb_7_e, Lb_7_a, Lb_7_1, p.style="stars")

cat("ICC final: ", 0.1802/(0.1802+129.4920), "\n",
    "PCV: ", (0.9627-0.1802)/0.9627, "\n")
```
...
Lb_2_g <- lmer(modelb7_2 ~ gender_v + (1 | intersections), data=NEA2022)

Lb_2_m <- lmer(modelb7_2 ~ migration_eu + migration_noeu  + (1 | intersections), data=NEA2022)

Lb_2_e <- lmer(modelb7_2 ~ education_laag + education_middel  + (1 | intersections), data=NEA2022)

Lb_2_a <- lmer(modelb7_2 ~ leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

Lb_2_1 <- lmer(modelb7_2 ~ gender_v + migration_eu + migration_noeu + 
    education_laag + education_middel + leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

tab_model(Lb_2_0, Lb_2_g, Lb_2_m, Lb_2_e, Lb_2_a, Lb_2_1, p.style="stars")

cat("ICC final: ", 0.1316/(0.1316+147.0932), "\n",
    "PCV: ", (0.233-0.1316)/0.233, "\n")
...
Lb_3_g <- lmer(modelb7_3 ~ gender_v + (1 | intersections), data=NEA2022)

Lb_3_m <- lmer(modelb7_3 ~ migration_eu + migration_noeu  + (1 | intersections), data=NEA2022)

Lb_3_e <- lmer(modelb7_3 ~ education_laag + education_middel  + (1 | intersections), data=NEA2022)

Lb_3_a <- lmer(modelb7_3 ~ leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

Lb_3_1 <- lmer(modelb7_3 ~ gender_v + migration_eu + migration_noeu + 
    education_laag + education_middel + leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

tab_model(Lb_3_0, Lb_3_g, Lb_3_m, Lb_3_e, Lb_3_a, Lb_3_1, p.style="stars")

cat("ICC final: ", 0.08042/(0.08042+214.96827), "\n",
    "PCV: ", (0.4709-0.08042)/0.4709, "\n")
```
...
Lb_4_g <- lmer(modelb7_4 ~ gender_v + (1 | intersections), data=NEA2022)

Lb_4_m <- lmer(modelb7_4 ~ migration_eu + migration_noeu  + (1 | intersections), data=NEA2022)

Lb_4_e <- lmer(modelb7_4 ~ education_laag + education_middel  + (1 | intersections), data=NEA2022)

Lb_4_a <- lmer(modelb7_4 ~ leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

Lb_4_1 <- lmer(modelb7_4 ~ gender_v + migration_eu + migration_noeu + 
    education_laag + education_middel + leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

tab_model(Lb_4_0, Lb_4_g, Lb_4_m, Lb_4_e, Lb_4_a, Lb_4_1, p.style="stars")

cat("ICC final: ", 0.21/(0.21+633.04), "\n",
    "PCV: ", (3.939-0.21)/3.939, "\n")
```
...
Lb_1_g <- lmer(modelb7_1 ~ gender_v + (1 | intersections), data=NEA2022)

Lb_1_m <- lmer(modelb7_1 ~ migration_eu + migration_noeu  + (1 | intersections), data=NEA2022)

Lb_1_e <- lmer(modelb7_1 ~ education_laag + education_middel  + (1 | intersections), data=NEA2022)

Lb_1_a <- lmer(modelb7_1 ~ leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

Lb_1_1 <- lmer(modelb7_1 ~ gender_v + migration_eu + migration_noeu + 
    education_laag + education_middel + leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

tab_model(Lb_1_0, Lb_1_g, Lb_1_m, Lb_1_e, Lb_1_a, Lb_1_1, p.style="stars")

cat("ICC final: ", 0.7291/(0.7291+424.4979), "\n",
    "PCV: ", (1.551-0.7291)/1.551, "\n")
...
Lb_5_g <- lmer(modelb7_5 ~ gender_v + (1 | intersections), data=NEA2022)

Lb_5_m <- lmer(modelb7_5 ~ migration_eu + migration_noeu  + (1 | intersections), data=NEA2022)

Lb_5_e <- lmer(modelb7_5 ~ education_laag + education_middel  + (1 | intersections), data=NEA2022)

Lb_5_a <- lmer(modelb7_5 ~ leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

Lb_5_1 <- lmer(modelb7_5 ~ gender_v + migration_eu + migration_noeu + 
    education_laag + education_middel + leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

tab_model(Lb_5_0, Lb_5_g, Lb_5_m, Lb_5_e, Lb_5_a, Lb_5_1, p.style="stars")

cat("ICC final: ", 2.152/(2.152+1436.346), "\n",
    "PCV: ", (3.643-2.152)/3.643, "\n")

```

```{r estimated safe, cache=TRUE}
...
df5 %>%
  ...
  gt() %>%
  tab_header(
    title = md("**Highest and lowest intersections probability safe**")
  ) %>%
  fmt_number(
    columns = "pred_mean_5",
    decimals = 5
...
Lb_6_g <- lmer(modelb7_6 ~ gender_v + (1 | intersections), data=NEA2022)

Lb_6_m <- lmer(modelb7_6 ~ migration_eu + migration_noeu  + (1 | intersections), data=NEA2022)

Lb_6_e <- lmer(modelb7_6 ~ education_laag + education_middel  + (1 | intersections), data=NEA2022)

Lb_6_a <- lmer(modelb7_6 ~ leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

Lb_6_1 <- lmer(modelb7_6 ~ gender_v + migration_eu + migration_noeu + 
    education_laag + education_middel + leeftijd_35.55 + leeftijd_55.75  + (1 | intersections), data=NEA2022)

tab_model(Lb_6_0, Lb_6_g, Lb_6_m, Lb_6_e, Lb_6_a, Lb_6_1, p.style="stars")

cat("ICC final: ", 2.243/(2.243+1254.959), "\n",
    "PCV: ", (15.09-2.243)/15.09, "\n")
```

```{r estimated highly safe, cache=TRUE}
