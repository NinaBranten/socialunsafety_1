...
Lb_7_a <- lmer(modelb7_7 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
ggplot(summary_preds_7, aes(x = leeftijd, y = mean_pred_7, color = gender)) +
  ...
  labs(
    title = "Predicted probability overall unsafety",
    y = NULL,
    x = NULL,
    color = "Gender"
  ) +
...
Lb_2_a <- lmer(modelb7_2 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
ggplot(summary_preds_2, aes(x = leeftijd, y = mean_pred_2, color = gender)) +
  ...
  labs(
    title = "Predicted probability supervisor unsafety",
    y = NULL,
    x = NULL,
    color = "Gender"
  ) +
...
Lb_3_a <- lmer(modelb7_3 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
ggplot(summary_preds_3, aes(x = leeftijd, y = mean_pred_3, color = gender)) +
  ...
  labs(
    title = "Predicted probability coworker unsafety",
    y = NULL,
    x = NULL,
    color = "Gender"
  ) +
...
Lb_4_a <- lmer(modelb7_4 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
ggplot(summary_preds_4, aes(x = leeftijd, y = mean_pred_4, color = gender)) +
  ...
  labs(
    title = "Predicted probability unsafe social climate",
    y = NULL,
    x = NULL,
    color = "Gender"
  ) +
...
Lb_1_a <- lmer(modelb7_1 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
ggplot(summary_preds_1, aes(x = leeftijd, y = mean_pred_1, color = gender)) +
  ...
  labs(
    title = "Predicted probability short-term conflict",
    y = NULL,
    x = NULL,
    color = "Gender"
  ) +
...
Lb_5_a <- lmer(modelb7_5 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
ggplot(summary_preds_5, aes(x = leeftijd, y = mean_pred_5, color = gender)) +
  ...
  labs(
    title = "Predicted probability safe",
    y = NULL,
    x = NULL,
    color = "Gender"
  ) +
...
Lb_6_a <- lmer(modelb7_6 ~ leeftijd__35.55 + leeftijd__55.75  + (1 | intersections), data=NEA2022)
...
ggplot(summary_preds_6, aes(x = leeftijd, y = mean_pred_6, color = gender)) +
  ...
  labs(
    title = "Predicted probability highly safe",
    y = NULL,
    x = NULL,
    color = "Gender"
  ) +
